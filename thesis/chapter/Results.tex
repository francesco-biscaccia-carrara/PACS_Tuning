...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{Success Rate vs. Computation Time for Dynamic Adjustment of Parameter $\rho$}
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{Success Rate vs. MIP Gap Plot for Dynamic Adjustment of Parameter $\rho$}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.4\columnwidth}
        ...
        \resizebox{\linewidth}{!}{\input{chapter/img/PACS_STD_VS_DYN/PACS_STD_DYN-MIPGapPlot_integrals.pgf}}
    \end{minipage}
    \caption{Success Rate vs. MIP Gap Plot forFixed vs. Dynamically Adjusted $\rho$ Test}
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{Success Rate vs. MIP Gap Plot for Slack Upper Bound Enforcement Test}
