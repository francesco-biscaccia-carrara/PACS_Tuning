...
\begin{tikzpicture}[
    rect/.style={rectangle, draw=black, align=center, font=\footnotesize},
    dashed-rect/.style={rectangle, draw=black, dashed, align=center, font=\footnotesize, fill=white},
    oval/.style={ellipse, draw=black, align=center, font=\footnotesize, fill=white},
    arrow/.style={->, >=Stealth},
    big-box/.style={rectangle, draw=black, dash pattern=on 5pt off 3pt, inner sep=12pt, fill=gray!50, fill opacity=0.3},
    label/.style={font=\footnotesize\bfseries}
]
% Initial Solution box - moved further left
\node[rect] (initial) at (-3,0) {Initial\\Solution};
% Variable Fixing 1 (dotted box)
\node[dashed-rect] (var-fix1) at (0,1) {Variable Fixing};
% Reduce Infeasibility oval
...
% Variable Fixing 2 (dotted box)
\node[dashed-rect] (var-fix2) at (9,1) {Variable Fixing};
% Minimize Objective oval  
\node[oval] (minimize) at (12.5,0) {Minimize\\Objective};
% Improved Quality Solution
\node[rect] (improved-qual) at (15.5,0) {Improved\\Quality\\Solution};
% Objective LNS dashed box
